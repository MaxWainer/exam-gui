...
INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
                                picture)
VALUES (1, 'Ривьера', 'План', 0, 'Москва', 8260042, 0.5, 4, LOAD_FILE('./images/Ривьера.jpg'));
INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
                                picture)
VALUES (2, 'Авиапарк', 'Строительство', 9, 'Санкт-Петербург', 3297976, 0.1, 3, LOAD_FILE('./images/Авиапарк.jpg'));
INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
                                picture)
...
INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
                                picture)
VALUES (6, 'Лужайка', 'Строительство', 10, 'Казань', 4603336, 0.1, 2, '');
INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
                                picture)
...
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (1, 'Чашин', 'Елизар', 'Михеевич', 'yntiRS', 'Администратор', '+7 (107) 628-29-16', 'М', 'Elizor@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (2, 'Филенкова', 'Владлена', 'Олеговна', '07i7Lb', 'Менеджер А', '+7 (334) 146-01-51', 'Ж', 'Vladlena@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (3, 'Ломовцев', 'Адам', 'Владимирович', '7SP9CV', 'Менеджер С', '+7 (856) 519-32-99', 'М', 'Adam@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (4, 'Тепляков', 'Кир', 'Федосиевич', '6QF1WB', 'Удален', '+7 (824) 893-24-03', 'М', 'Kar@gmail.com', null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (5, 'Рюриков', 'Юлий', 'Глебович', 'GwffgE', 'Администратор', '+7 (640) 701-31-91', 'М', 'Yli@gmail.com', null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (6, 'Беломестина', 'Василиса', 'Тимофеевна', 'd7iKKV', 'Администратор', '+7 (920) 920-74-47', 'Ж',
        'Vasilisa@gmail.com', null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (7, 'Панькива', 'Галина', 'Якововна', '8KC7wJ', 'Менеджер А', '+7 (405) 088 73 89', 'Ж', 'Galina@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (8, 'Зарубин', 'Мирон', 'Мечиславович', 'x58OAN', 'Администратор', '+7 (601) 195-02-09', 'М', 'Miron@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (9, 'Веточкина', 'Всеслава', 'Андрияновна', 'fhDSBf', 'Менеджер С', '+7 (078) 429-57-86', 'Ж',
        'Vseslava@gmail.com', null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (10, 'Рябова', 'Виктория', 'Елизаровна', '9mlPQJ', 'Удален', '+7 (639) 904-01-61', 'Ж', 'Victoria@gmail.com',
        null);
INSERT INTO production.employers (employer_id, second_name, name, patronymic, password, role, phone_number, sex, login,
                                  photo)
VALUES (11, 'Федотов', 'Леон', 'Фёдорович', 'Wh4OYm', 'Менеджер А', '+7 (223) 326-49-59', 'М', 'Anisa@gmail.com', null);

create table pavilions
(
    pavilion_id      int                       not null primary key auto_increment,
    center_id        int                       not null,
    pavilion_number  varchar(25) charset utf8  not null,
    floor            int                       not null,
    status           varchar(255) charset utf8 not null,
    square           int                       not null,
    price_per_square decimal(15, 2)            not null,
    value_factor     float                     not null,
    constraint pavilions_centers_center_id_fk
        foreign key (center_id) references centers (center_id)
);

INSERT INTO production.pavilions (pavilion_id, center_id, pavilion_number, floor, status, square, price_per_square,
                                  value_factor)
...
INSERT INTO production.rent (rent_id, renter_id, name, employer_id, pavilion_id, status, rent_start, rent_end)
...
#
# DELETE FROM production.centers WHERE center_id=51;
# INSERT INTO production.centers (center_id, name, status, pavilion_count, city, price, value_factor, floor_count,
#                                 picture)
# VALUES (51, 'Авиапарк', 'Строительство', 9, 'Санкт-Петербург', 3297976, 0.1, 3, LOAD_FILE('Авиапарк.jpg'));
#
# SELECT LOAD_FILE('E://ProgramData//MySQL//MySQL Server 8.0//Uploads//Авиапарк.jpg');